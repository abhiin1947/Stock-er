...
$i=1;
while($c7_r3=mysql_fetch_array($c3))
{
//echo $c7_r3[0]." ".$c7_r3[1];
//print_r($c7_r3);
//echo "<br />";
$v2[$i]=(float)$c7_r3['TOTTRDQTY'];
$i++;
}
...
mysql_query(correl($v1,$v2,7,$val[0],$day,"c7_r3"),$conn);
//echo correl($v1,$v2,7,$val[0],$day,"c7_r3");
$sql1="select r2 from data where day>=".$day." and day<".$eday." and SYMBOL='".$val[0]."' order by day asc";
//echo $sql1;
$c3=mysql_query($sql1,$conn);
$i=1;
while($c7_r2=mysql_fetch_array($c3))
{
//echo $c7_r2[0]." ".$c7_r2[1];
//print_r($c7_r2);
//echo "<br />";
$v1[$i]=(float)$c7_r2['r2'];
$i++;
}
mysql_query(correl($v1,$v2,7,$val[0],$day,"c7_r2"),$conn);
$sql1="select r1 from data where day>=".$day." and day<".$eday." and SYMBOL='".$val[0]."' order by day asc";
//echo $sql1;
$c3=mysql_query($sql1,$conn);
$i=1;
while($c7_r1=mysql_fetch_array($c3))
{
//echo $c7_r1[0]." ".$c7_r1[1];
//print_r($c7_r1);
//echo "<br />";
$v1[$i]=(float)$c7_r1['r1'];
$i++;
...
mysql_query(correl($v1,$v2,7,$val[0],$day,"c7_r1"),$conn);
$sql1="select pivot from data where day>=".$day." and day<".$eday." and SYMBOL='".$val[0]."' order by day asc";
//echo $sql1;
$c3=mysql_query($sql1,$conn);
$i=1;
while($c7_pivot=mysql_fetch_array($c3))
{
//echo $c7_pivot[0]." ".$c7_pivot[1];
//print_r($c7_pivot);
//echo "<br />";
$v1[$i]=(float)$c7_pivot['pivot'];
$i++;
}
mysql_query(correl($v1,$v2,7,$val[0],$day,"c7_pivot"),$conn);
$sql1="select s1 from data where day>=".$day." and day<".$eday." and SYMBOL='".$val[0]."' order by day asc";
//echo $sql1;
$c3=mysql_query($sql1,$conn);
$i=1;
while($c7_s1=mysql_fetch_array($c3))
{
//echo $c7_s1[0]." ".$c7_s1[1];
//print_r($c7_s1);
//echo "<br />";
$v1[$i]=(float)$c7_s1['s1'];
$i++;
}
mysql_query(correl($v1,$v2,7,$val[0],$day,"c7_s1"),$conn);
$sql1="select s2 from data where day>=".$day." and day<".$eday." and SYMBOL='".$val[0]."' order by day asc";
//echo $sql1;
$c3=mysql_query($sql1,$conn);
$i=1;
while($c7_s2=mysql_fetch_array($c3))
{
//echo $c7_s2[0]." ".$c7_s2[1];
//print_r($c7_s2);
//echo "<br />";
$v1[$i]=(float)$c7_s2['s2'];
$i++;
}
mysql_query(correl($v1,$v2,7,$val[0],$day,"c7_s2"),$conn);
$sql1="select s3 from data where day>=".$day." and day<".$eday." and SYMBOL='".$val[0]."' order by day asc";
//echo $sql1;
$c3=mysql_query($sql1,$conn);
$i=1;
while($c7_s3=mysql_fetch_array($c3))
{
//echo $c7_s3[0]." ".$c7_s3[1];
//print_r($c7_s3);
//echo "<br />";
$v1[$i]=(float)$c7_s3['s3'];
$i++;
}
mysql_query(correl($v1,$v2,7,$val[0],$day,"c7_s3"),$conn);
}
//}
?>
...
<h1><center><b>Loading 14 day Data</b></center></h1>
<form id="go" action="load2.php" method="post">
</form>
</body>
</html>
